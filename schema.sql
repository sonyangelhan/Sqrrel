...
-- Dumping data for table tweetnote.com: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `note` (
  ...
  KEY `FK_note_com` (`com_id`),
  CONSTRAINT `FK_note_com` FOREIGN KEY (`com_id`) REFERENCES `com` (`com_id`) ON DELETE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `todo` (
  ...
  KEY `FK_todo_com` (`com_id`),
  CONSTRAINT `FK_todo_com` FOREIGN KEY (`com_id`) REFERENCES `com` (`com_id`) ON DELETE NO ACTION,
